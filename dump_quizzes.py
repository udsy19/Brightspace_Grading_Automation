...
if __name__ == "__main__":
    if connect():
        ...
        page.goto("https://purdue.brightspace.com/d2l/lms/quizzing/user/quizzes_list.d2l?ou=1368903")
        page.wait_for_load_state("networkidle")
        try:
            table_html = page.locator(".d2l-table").first.inner_html()
            with open("quizzes_table.html", "w") as f:
                f.write(table_html)
            print("Dumped quizzes_table.html")
